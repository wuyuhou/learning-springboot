...
import com.primeton.learns.springboot.jpa.demo.dao.IdEntityDao;
import com.primeton.learns.springboot.jpa.demo.model.IdEntity;
	...
	public static class IdEntityService {
		...
		public IdEntity getIdEntity(String idName) {
			...
			if (idEntity == null) {
				...
				idEntityDao.saveAndFlush(idEntity);
			} else {
